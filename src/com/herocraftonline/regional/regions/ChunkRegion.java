...
public class ChunkRegion extends CubeRegion {
	...
	public ChunkRegion(String name, short id, String worldName, Plugin plugin) {
	...
	public ChunkRegion(String name, short id, String worldName, byte weight, List<String> namespaces, short parent) {
		super(name, id, worldName, weight, namespaces, parent);
	}
